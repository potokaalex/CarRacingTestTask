...
{
    public class GameLoadState : IStateAsync
    {
        private readonly IAssetLoader<GameConfig> _assetLoader;
        ...
        public GameLoadState(IAssetLoader<GameConfig> assetLoader, IProgressLoader<PlayerProgress> progressLoader, IUpdater updater,
        ...
        public async UniTask Enter()
        {
            ...
            _stateMachine.SwitchTo<GameState>();
            _updater.OnDispose += () => _stateMachine.SwitchTo<GameUnLoadState>();
        }
    }
}